document.addEventListener('DOMContentLoaded', async () => {
    ...
    supabaseClient.auth.onAuthStateChange((event, session) => {
        // If we are in the password reset flow, just set the currentUser and let the updatePasswordModal logic handle UI
        // We only proceed with standard UI updates if NOT in a password reset flow that has successfully displayed the modal.
    ...
    function handleCreateNewPack() {
        ...
        if (editPackSelection) editPackSelection.value = packName;
    ...
    function resetGameFull() {
        ...
        const allScreens = [
            playerNameInputSection, gameSection, mrWhiteGuessSection, eliminationResultPopup, 
            winnerPopupModal, roundOverSection, finalScoreDisplayModal, cardRevealModal, 
            musicSettingsModal, peekPlayerSelectModal, massPenaltyModal, howToPlayModal, 
            wordPackManagerModal, authModal, forgotPasswordModal, updatePasswordModal
        ];
