document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- PERBAIKAN BUG: Logika tebakan Mr. White diperbaiki ---
    function handleMrWhiteGuess() {
        ...
        if (isMrWhiteFinalDuel) {
            gameInProgress = false; // Duel terakhir pasti mengakhiri permainan
            isMrWhiteFinalDuel = false;
            ...
            if (guess.toLowerCase() === civilianWord.toLowerCase()) {
                gameInProgress = false; // Permainan berakhir karena Mr. White menang.
                playWinSound();
                currentWinningTeamType = "MR_WHITE_GUESS";
                ...
                // Jika Mr. White GAGAL menebak, permainan BELUM berakhir.
                playLoseSound();
